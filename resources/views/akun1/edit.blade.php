      ...
      <form action="{{ route('akun1.update', $akun1->id) }}" method="POST">
        ...
        <div class="space-y-3">
          <div class="space-y-2">
            ...
            <x-forms.text-input id="kode" name="kode" :value="old('kode', $akun1->kode)" placeholder="Masukan Kode Akun 1"
          ...
          <div class="space-y-2">
            ...
            <x-forms.text-input id="nama" name="nama" :value="old('nama', $akun1->nama)" placeholder="Masukan Nama Akun 1"
