      ...
      <form action="{{ route('akun3.store') }}" method="POST">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <x-forms.text-input id="kode" name="kode" :value="old('kode')" placeholder="Masukan Kode Akun 3"
          ...
          <div class="space-y-2">
            ...
            <x-forms.text-input id="nama" name="nama" :value="old('nama')" placeholder="Masukan Nama Akun 3"
