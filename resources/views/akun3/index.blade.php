      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <x-card class="overflow-hidden">
          <x-card.header>
            ...
            <x-slot:actions>
              <x-button as="a" href="{{ route('akun3.create') }}" size="sm">Tambah</x-admin.button>
            </x-slot>
            </x-admin.card.header>
            ...
            <x-table>
              <x-table.thead>
                ...
                <x-table.tbody>
                  @forelse ($akun3s as $akun3)
                    <tr>
                      ...
                      <x-table.td>
                        <div class="px-6 py-3">
                          <span
                            class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $akun3->kode }}</span>
                        </div>
                        </x-admin.table.td>
                        ...
                        <x-table.td class="h-px w-72">
                          ...
                          <x-table.td class="h-px w-72">
                            ...
                            <x-table.td class="h-px w-72">
                              <div class="px-6 py-3">
                                <span
                                  class="text-sm text-gray-500 dark:text-neutral-500">{{ $akun3->akun2->nama }}</span>
                              </div>
                              </x-admin.table.td>
                  ...
                  <x-card.footer>{{ $akun3s->links() }}</x-admin.card.footer>
                    </x-admin.card>
      </div>
    </div>
  </div>
