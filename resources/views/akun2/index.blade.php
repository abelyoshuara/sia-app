      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <x-card class="overflow-hidden">
          <x-card.header>
            ...
            <x-slot:actions>
              <x-button as="a" href="{{ route('akun2.create') }}" size="sm">Tambah</x-admin.button>
            </x-slot>
            </x-admin.card.header>
            ...
            <x-table>
              <x-table.thead>
                ...
                <x-table.tbody>
                  @forelse ($akun2s as $akun2)
                    <tr>
                      ...
                      <x-table.td>
                        <div class="px-6 py-3">
                          <span
                            class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $akun2->kode }}</span>
                        </div>
                        </x-admin.table.td>
                  ...
                  <x-card.footer>{{ $akun2s->links() }}</x-admin.card.footer>
                    </x-admin.card>
      </div>
    </div>
  </div>
