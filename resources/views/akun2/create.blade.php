      ...
      <form action="{{ route('akun2.store') }}" method="POST">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <x-forms.text-input id="kode" name="kode" :value="old('kode')" placeholder="Masukan Kode Akun 2"
          ...
          <div class="space-y-2">
            ...
            <x-forms.text-input id="nama" name="nama" :value="old('nama')" placeholder="Masukan Nama Akun 2"
