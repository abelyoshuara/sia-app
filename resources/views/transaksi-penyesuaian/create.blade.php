      ...
      <form action="{{ route('transaksi-penyesuaian.store') }}" method="POST"
        ...
        <div class="w-full lg:w-1/4 px-4 space-y-4">
          ...
          <div class="space-y-2">
            ...
            <x-admin.forms.text-input type="number" id="nilai" name="nilai" :value="old('nilai')"
          ...
          <div class="space-y-2">
            ...
            <x-admin.forms.text-input type="number" id="waktu" name="waktu" :value="old('waktu')"
          ...
          <div class="space-y-2">
            ...
            <x-admin.forms.text-input id="jumlah" name="jumlah" :value="old('jumlah')" :error="$errors->first('jumlah')"
