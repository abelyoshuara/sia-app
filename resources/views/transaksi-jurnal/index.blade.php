<x-layouts.app title="Transaksi Jurnal">
    ...
    <div class="-m-1.5 overflow-x-auto">
      <div class="p-1.5 min-w-full inline-block align-middle">
        <x-admin.card class="overflow-hidden">
                ...
                <tr>
                  ...
                  <x-admin.table.td>
                    <div class="inline-flex">
                      ...
                      <x-admin.button as="a" href="{{ route('transaksi-jurnal.edit', $tj->id) }}" variant="link"
                        size="sm">
                        Ubah
                      </x-admin.button>
          ...
          <x-admin.card.footer>{{ $transaksiJurnal->links() }}</x-admin.card.footer>
        </x-admin.card>
      </div>
    </div>
  </div>
  ...
  <x-admin.modal id="detail-modal" size="lg">
    <x-admin.modal.header dismiss="#detail-modal">Detail Transaksi Jurnal</x-admin.modal.header>
