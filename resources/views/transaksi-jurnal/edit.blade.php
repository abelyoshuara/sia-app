      ...
      <form action="{{ route('transaksi-jurnal.update', $transaksiJurnal->id) }}" method="POST"
        ...
        <div class="w-full lg:w-1/4 px-4 space-y-4">
          <div class="space-y-2">
            ...
            <x-admin.forms.text-input id="kwitansi" name="kwitansi" :value="old('kwitansi', $transaksiJurnal->kwitansi)" placeholder="Masukan Kwitansi"
          ...
          <div class="space-y-2">
            ...
            <x-admin.forms.text-input type="date" id="tanggal" name="tanggal" :value="old('tanggal', $transaksiJurnal->tanggal)"
